                        ...
                        <div className="twm-s-info2-wrap mb-5">
                          <div className="twm-s-info2">
                            ...
                            <div className="twm-social-tags">
                              <a
                                target="_blank"
                                href={`tel:${experienceData?.experience?.contect &&
                                  JSON.parse(
                              ...
                              <a
                                target="_blank"
                                href={`mailto:${experienceData?.experience?.contect &&
                                  JSON.parse(
                                    experienceData?.experience?.contect
                                  )?.email
                                  }`}
                              ...
                              <a
                                target="_blank"
                                href={`https://web.whatsapp.com/send?phone=${experienceData?.experience?.contect &&
                                  JSON.parse(
                                    experienceData?.experience?.contect
                                  )?.whatsapp
                                  }&text=Hello`}
                            ...
                            (item, key) => (
                              ...
                              >
                                <div className="wt-post-media">
                                  <Link to={"/latestexoerience"} state={{ id: item?.id }} onClick={() => handleReletedBusiness(item?.id)}>
                                ...
                                <div className="wt-post-info">
                                  ...
                                  <div className="wt-post-readmore">
                                    <a
                                      onClick={() => handleReletedBusiness(item?.id)}
